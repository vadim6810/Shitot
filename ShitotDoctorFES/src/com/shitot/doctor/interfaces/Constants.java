...
public interface Constants {
     ...
     * String ERROR_LOGIN = "Username or password is wrong"; String
     * ERROR_EXISTED_PERSON = "Current person is already in your Address Book";
     * String ERROR_REPEAT = ""; String ERROR_CREATE_CALENDAR =
     * "Error to create new Calendar"; String ERROR_REMOVE_CALENDAR =
     * "Current calendar has not been not found";
     * 
     * String ERROR_GET_WEEK = "Error in getting week"; String
     * ERROR_EDIT_CALENDAR = "Error editing calendar";
     */
