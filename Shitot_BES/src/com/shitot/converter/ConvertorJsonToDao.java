...
public class ConvertorJsonToDao {
	...
	public static TreatmentDAO convertTreatment(Treatment tr) {
		...
		treatmentDao.setMeetingDate(tr.getDateMeeting());
		treatmentDao.setPaymentDate(tr.getDatePayment());
		...
		treatmentDao.setUserName(tr.getNameUser());
		treatmentDao.setApplyDate(tr.getDateApplication());
	...
	public static ClinicDAO convertClinic(Clinic clinic) {
		...
		clinicDao.setAddress(clinic.getAddressClinic());
