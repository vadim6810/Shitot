...
public class ConvertorDaoToJson {
	...
	public static Treatment convertTreatment(TreatmentDAO tr) {
		...
		treatmentJson.setDateMeeting(tr.getMeetingDate());
		treatmentJson.setDatePayment(tr.getPaymentDate());
		...
		treatmentJson.setNameUser(tr.getUserName());
		treatmentJson.setDateApplication(tr.getApplyDate());
	...
	public static Problem convertProblem(ProblemDAO problemDao) {
		...
		problemJson.setName(problemDao.getName());
	...
	public static Clinic convertClinic(ClinicDAO clinicDao) {
		...
		clinicJson.setAddressClinic(clinicDao.getAddress());
